...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2017 a las 13:02:58
...
INSERT INTO `newsletters` (`id`, `tittle`, `message`, `id_ladingpage`, `created_at`, `exp_at`) VALUES
(4, 'sda as', 'asd as', 4, '2017-10-27 08:00:00', '2017-10-28 08:00:00');
...
CREATE TABLE `newsletters_viewers` (
  ...
  `ip` varchar(11) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Volcado de datos para la tabla `newsletters_viewers`
--

INSERT INTO `newsletters_viewers` (`id`, `id_lading`, `id_newletter`, `ip`) VALUES
(1, 1, 1, '::1'),
(2, 4, 4, '::1');
...
(1, 'Gomas', 0, 'Esta es la descripcion del producto', 'img/lñdsakj.jpg'),
(2, 'Ruedas', 0, '', '');
